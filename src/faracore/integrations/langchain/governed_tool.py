"""
LangChain integration for FaraCore - Governed Tool Wrapper

This module provides a wrapper that intercepts LangChain tool calls,
submits them to FaraCore for governance, and waits for approval before execution.
"""
...
class GovernedTool:
    """
    Wrapper for LangChain tools that enforces FaraCore governance.
    
    Usage:
        from langchain.tools import ShellTool
        from faracore.integrations.langchain import GovernedTool
    ...
    def __init__(
        ...
        Args:
            ...
            client: FaraCore ExecutionGovernorClient
    ...
    def run(self, *args, **kwargs) -> str:
        """
        Execute the tool with FaraCore governance.
        
        This method:
        1. Submits the tool call to FaraCore
        2. Waits for approval if pending
        3. Executes the tool if allowed/approved
        4. Reports result back to FaraCore
