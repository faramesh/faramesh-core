"""Interactive REPL shell for FaraCore."""
...
class FaraShell:
    """Interactive REPL for FaraCore commands."""
    ...
    def __init__(self, args: argparse.Namespace):
        ...
        self.history_file = os.path.expanduser("~/.faracore_history")
...
"""
        if self.console:
            self.console.print(Panel(help_text, title="FaraCore Shell", border_style="cyan"))
        else:
            print(help_text)
    ...
    def run(self) -> None:
        ...
        if self.console:
            self.console.print("[cyan]FaraCore Interactive Shell[/cyan]")
            self.console.print("Type 'help' for commands, 'exit' to quit\n")
        else:
            print("FaraCore Interactive Shell")
