"""Decorator for governing tool functions with FaraCore.

This module provides the `governed_tool` decorator that wraps functions
to submit them to FaraCore for policy evaluation before execution.
"""
...
def governed_tool(
    ...
    *,
    ...
    """Decorator that submits function calls to FaraCore for governance.
    
    On function call:
    - Submits an action to FaraCore with agent_id, tool, operation (or function.__name__)
